...
class ApiUrls {
  ...
  static Function trendingMovies =
      (String timeWindow) => '/trending/movie/$timeWindow';
  static Function trendingTv =
      (String timeWindow) => '/trending/tv/$timeWindow';
  ...
  static Function tvSeasonDetails =
      (int id, int season) => '/tv/$id/season/$season';
  ...
  static Function image =
      (String path) => 'https://image.tmdb.org/t/p/w500/$path';
  static Function videoThumbnail =
      (String key) => 'https://img.youtube.com/vi/$key/0.jpg';
  // static Function personTvCredits = (int id) => '/person/$id/tv_credits';
}
